...
export default function NewQuoteDocumentPage() {
            ...
            <div className="flex items-center gap-4 mb-3">
              ...
              <div>
                <h1 className="text-4xl lg:text-5xl font-black text-white">
                  새 <span className="text-green">견적서</span>
                </h1>
                <p className="text-lg text-gray-400 mt-2">새 견적서를 작성합니다.</p>
              </div>
            </div>
          </motion.div>
